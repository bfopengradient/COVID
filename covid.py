...
class c:		
	...
	#cdc= pd.read_csv('/Users/brianfarrell/Desktop/cdc.csv',index_col=0)
	...
	def country(data,country):
		...
		#plot new cases versus old cases and deaths(up to and inclduing 14 days)
		...
		#plot new deaths versus old cases and deaths(up to and inclduing 14 days)
		plt.figure(figsize=(15,5))
